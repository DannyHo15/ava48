      ...
      <div className="avatar-container relative">
        <div className="flex items-end justify-center min-h-screen">
          ...
          <div className="absolute left-[9%] top-[50%] prm:left-[8%] prm:top-[54%] z-15 sm:left-[5%] sm:top-[49%] 2xl:top-[38%] 2xl:left-[11%] sm:z-15 md:z-10 2xl:z-20">
            <h1
              className="font-karantina text-[60px] prm:text-custom-70 sm:text-[120px] 2xl:text-[160px] font-black drop-shadow-amber-950 drop-shadow-xs bg-[linear-gradient(135deg,#FFFFFF_50%,#3EF8FF_150%)] bg-clip-text text-transparent uppercase leading-[86%]"
              style={{
          ...
          <div className="absolute right-2 prm:right-8 sm:right-[7%] bottom-[29%] prm:bottom-[26%] sm:bottom-[31%] 2xl:bottom-[24%] 2xl:right-[9%] z-20 ">
            <h2
              className="font-karantina text-[45px] font-bold prm:text-[55px] sm:text-[100px] 2xl:text-[120px] sm:font-black text-white uppercase leading-[86%] text-right"
              style={{
                filter: "drop-shadow(1.7px 2.55px 1.53px rgba(0, 0, 0, 0.4))",
              }}
            >
