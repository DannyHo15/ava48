      ...
      <div className="avatar-container relative">
        ...
        <div className="flex items-end justify-center min-h-dvh">
          ...
          <div className="relative max-w-6xl flex justify-center mb-0 pt-24 md:pt-32 2xl:pt-[97px]">
            ...
            {/* <div className="absolute rounded-full blur-[120px] w-[794.69px] h-[552px] top-[38%] sm:w-[1657px] sm:h-[1153px] sm:top-[22%] bg-linear-to-br from-avatar-blue-3 dark:from-[#f200ff] from-20% via-avatar-blue-5 to-avatar-blue-4 dark:top-avatar -rotate-[4.54deg] opacity-56 mix-blend-screen"></div> */}
