  ...
  return (
    <SectionWrapper>
      ...
      <div className="avatar-container relative">
        <div className="absolute w-[1342px] h-[496px] prm:w-[1643px] sm:w-[1568px] sm:h-[552px] prm:[657px] bottom-0 right-[-219%] prm:right-[-215%] prm:bottom-[10%] sm:right-[-20%] sm:bottom-0  2xl:w-[1984px] 2xl:h-[794px] 2xl:right-[-22%] 2xl:bottom-[0%]  bg-[url(/assets/bg-texture.webp)] bg-contain bg-bottom mix-blend-plus-lighter z-10 bg-no-repeat max-h-dvh " />
        <div className="flex items-end justify-center min-h-dvh">
          <div className="absolute rounded-full w-[794.69px] h-[552px] top-[38%] sm:w-[1657px] sm:h-[1153px] sm:top-[22loca%] bg-linear-to-br from-avatar-blue-3 dark:from-[#f200ff] from-20% via-avatar-blue-5 to-avatar-blue-4 dark:top-avatar blur-[120px] -rotate-[4.54deg] opacity-56 mix-blend-screen"></div>
          <DiamondDots
          ...
          <div className="absolute right-2 prm:right-8 sm:right-[7%] bottom-[29%] prm:bottom-[26%] sm:bottom-[31%] 2xl:bottom-[24%] 2xl:right-[9%] z-20 ">
            ...
            <ShapeGradientWrapper
              ...
              shapeWidth={153}
              shapeHeight={70}
              className="sm:top-[54%] sm:right-[-21%] z-10 hidden 2xl:block"
              strokeColor={[
                { offset: "20%", stopColor: "rgba(255, 255, 255, 1)" },
                { offset: "100%", stopColor: "rgba(255, 255, 255, 0)" },
              ]}
              ...
              strokeWidth={1}
              path={
                "M 0,10 A 20,20 0,0,1 10,0 L 143,0 A 20,20 0,0,1 153,10 L 153,42 A 7,3 0,0,1 152,44 L 109,68 A 7,3 0,0,1 107,70 L 10,70 A 20,20 0,0,1 0,60 Z"
              }
            />
