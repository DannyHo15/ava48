...
export const AvatarLink = () => {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-6.5 sm:bottom-15 lg:bottom-6.75 right-5 sm:right-10 lg:right-11.75 z-10 min-[420px]:h-9.75 sm:h-31 xl:h-22 transition-all overflow-hidden rounded-b-full min-[420px]:rounded-b-none space-y-px min-[420px]:space-y-0",
        openLink ? "h-30" : "h-10"
      )}
    >
      <div className="block min-[420px]:flex sm:block gap-2 underline decoration-[0.5px] underline-offset-4 font-light text-white text-xl space-y-px min-[420px]:space-y-0 sm:space-y-6 xl:space-y-3">
        <a
          href="https://x.com/aya_avatar48"
          target="blank"
          className="flex-center-y justify-center xl:justify-end size-9.75 sm:size-12.5 xl:h-auto xl:w-full rounded-full bg-white/10 xl:bg-transparent max-xl:backdrop-blur-md"
        >
