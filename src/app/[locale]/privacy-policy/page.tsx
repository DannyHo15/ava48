...
function Page() {
  ...
  return (
    <>
      ...
      <div className="py-24 sm:py-32 lg:py-24 text-white" id="smooth-content">
        <div className="lg:max-w-[690px] xl:max-w-[1200px] lg:mx-auto overflow-hidden rounded-lg p-5 sm:p-10">
