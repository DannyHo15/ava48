...
export async function generateMetadata(
  ...
  const defaultKeywords = [
    "Avatar48", "AI companion", "AI girlfriend", "emotional AI", "virtual chat", 
    "flirty AI", "Aya Fujimoto", "Eimi Fukada", "crypto AI", "AI relationship", 
    "Heart to Token", "chat to earn", "call to earn", "AI rewards", "Web3 AI", 
    "AI crypto", "AI virtual assistant", "digital twin", "crypto news", "AI intimacy"
  ];
